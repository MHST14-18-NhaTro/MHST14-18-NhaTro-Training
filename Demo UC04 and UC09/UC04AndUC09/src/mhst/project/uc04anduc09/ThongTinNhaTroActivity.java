...
public class ThongTinNhaTroActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		giaPhong.setText(intent.getStringExtra(NhaTroDatabaseHelper.colGiaPhong));
		soPhong.setText(intent.getStringExtra(NhaTroDatabaseHelper.colSoPhong));
		dienTichPhong.setText(intent.getStringExtra(NhaTroDatabaseHelper.colDienTichPhong));
		oGhep.setText(intent.getStringExtra(NhaTroDatabaseHelper.colOGhep));
		thongTinThem.setText(intent.getStringExtra(NhaTroDatabaseHelper.colThongTinThem));
		tenChuTro.setText(intent.getStringExtra(NhaTroDatabaseHelper.colTenChuTro));
		soDienThoai.setText(intent.getStringExtra(NhaTroDatabaseHelper.colSoDienThoai));
